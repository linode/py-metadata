...
from linode_metadata.objects.networking import Interfaces, IPv4Networking, IPv6Networking, NetworkResponse


def test_interfaces():
    interface_data: Dict[str, Any] = {"label": "eth0", "purpose": "public", "ipam_address": "192.168.1.1/24"}
...
def test_ipv4_networking():
    ipv4_data: Dict[str, Any] = {"public": ["192.168.1.2"], "private": ["10.0.0.1"], "shared": ["172.16.0.1"]}
...
def test_ipv6_networking():
    ipv6_data: Dict[str, Any] = {"slaac": "2001:db8::1:2a4f:8c7b:9d2e", "link_local": "fe80::1", "ranges": ["2001:db8::1"], "shared_ranges": ["fd00::1"]}
...
def test_network_response():
    interfaces_data: Dict[str, Any] = [{"label": "eth0", "purpose": "public", "ipam_address": "192.168.1.1"}]
    ipv4_data: Dict[str, Any] = {"public": ["192.168.1.2"], "private": ["10.0.0.1"], "shared": ["172.16.0.1"]}
    ipv6_data: Dict[str, Any] = {"slaac": "2001:db8::1:2a4f:8c7b:9d2e", "link_local": "fe80::1", "ranges": ["2001:db8::1"], "shared_ranges": ["fd00::1"]}

    network_data = {"interfaces": interfaces_data, "ipv4": ipv4_data, "ipv6": ipv6_data}
