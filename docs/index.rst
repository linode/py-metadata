...
Metadata Service API.  For API documentation, see `developers.linode.com`_.

This library can be used to interact with the Metadata Service API.

.. _developers.linode.com: https://www.linode.com/docs/products/compute/compute-instances/guides/metadata/
